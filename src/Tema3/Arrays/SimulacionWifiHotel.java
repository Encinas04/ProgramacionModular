...
public class SimulacionWifiHotel {
    public static void main(String[] args) {
        ...
        while (planta < 0 || planta >= filas || habitacion < 0 || habitacion >= columnas || potencia < 1 || potencia > 5) {
            ...
            System.out.println("Selecciona la potencia del router (1-5): ");
            potencia = scanner.nextInt();

            if (planta < 0 || planta >= filas || habitacion < 0 || habitacion >= columnas || potencia < 1 || potencia > 5) {
                System.out.println("Entrada inválida. Asegúrese de que la planta esté entre 1 y 12, la habitación entre 1 y 5, y la potencia entre 1 y 5.");
            }
        }
